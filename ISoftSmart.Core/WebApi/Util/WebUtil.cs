...
{
    public sealed class WebUtil : IDisposable
    {
        ...
        public string DoJsonRequest(string url, string jsonData, string method, string token = "")
        {
        ...
        public HttpWebRequest GetWebRequest(String url, String method)
        {
            ...
            req.Method = method;
            req.KeepAlive = true;
            req.UserAgent = "API development from Dean";
